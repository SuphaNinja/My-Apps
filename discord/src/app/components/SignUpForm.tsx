...
const SignUpForm = () => {
    ...
    <form onSubmit={handleSubmit(saveUser)} className="grid grid-cols-2 gap-5 p-3 shadow border-2 border-slate-500 rounded-xl mx-auto max-w-[60rem]">
        <Input {...register("firstName")} className="col-span-2 md:col-span-1" label="First Name" startContent={<UserIcon className="w-4" />}/>
        <Input {...register("lastName")} className="col-span-2 md:col-span-1" label="Last Name" startContent={<UserIcon className="w-4" />}/>
        <Input {...register("userName")} className="col-span-2 md:col-span-1" label="User Name" startContent={<AtSymbolIcon className="w-4" />}/>
        <Input {...register("phoneNumber")} className="col-span-2 md:col-span-1" label="Phone Number" startContent={<PhoneIcon className="w-4" />}/> 
        <Input {...register("email")} className="col-span-2" label="Email" startContent={<EnvelopeIcon className="w-4" />}/>
        <Input 
            {...register("password")}
            label="Password" 
